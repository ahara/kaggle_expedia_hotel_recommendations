...
if __name__ == '__main__':
    ...
    clf_base = SGDClassifier(loss='modified_huber', n_jobs=8, n_iter=1, random_state=1, warm_start=True)
    ...
    i = 0
    for train_nb, labels_nb in read_data_generator(selected_cols, encoder, chunk_size=10**5):
        print labels_nb[:20]
        i += 1
